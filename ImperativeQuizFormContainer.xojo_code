...
Begin WebContainer ImperativeQuizFormContainer
   Compatibility   =   ""
   ControlCount    =   0
   ControlID       =   ""
   Enabled         =   True
...
#tag WindowCode
	...
	#tag ComputedProperty, Flags = &h0
		#tag Getter
			Get
			  Return ResponseTextField.Text
			End Get
		#tag EndGetter
		#tag Setter
			Set
			  ResponseTextField.Text = value
			End Set
		#tag EndSetter
		Response As String
...
#tag Events ResponseTextField
	#tag Event
		Sub TextChanged()
		  SubmitButton.Enabled = Me.Text.Trim <> ""
		  OutcomeLabel.Text = ""
		End Sub
	#tag EndEvent
#tag EndEvents
#tag Events SubmitButton
	#tag Event
		Sub Pressed()
		  Me.Enabled = False
		  OutcomeLabel.Text = ""
		  ResponseTextField.Enabled = False
